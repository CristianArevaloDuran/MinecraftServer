    ...
    public void attack(Entity entity) {
        if (entity.isAttackable()) {
            if (!entity.skipAttackInteraction(this)) {
                ...
                float f1 = EnchantmentManager.getDamageBonus(this.getMainHandItem(), entity.getType());
                ...
                if (entity.getType().is(TagsEntity.REDIRECTABLE_PROJECTILE) && entity instanceof IProjectile) {
                    ...
                    if (f > 0.0F || f1 > 0.0F) {
                        ...
                        i += EnchantmentManager.getKnockbackBonus(this);
                        ...
                        f += this.getItemInHand(EnumHand.MAIN_HAND).getItem().getAttackDamageBonus(this, f);
    ...
    public boolean causeFallDamage(float f, float f1, DamageSource damagesource) {
        if (this.abilities.mayfly) {
            ...
            if (this.ignoreFallDamageFromCurrentImpulse && this.currentImpulseImpactPos != null) {
                ...
                return d0 < this.getY() ? false : super.causeFallDamage((float) (d0 - this.getY()), f1, damagesource);
            } else {
